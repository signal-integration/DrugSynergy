compute_profile_means = function(PROFCODES,
  ...
  #computes a vector of mean values of (e0, eX, eY, eX+Y) for a profile of interest.
  
  #REQUIRES
  #PROFCODES (definitions of all profiles in terms of ternary vectors) 
  #prof_index: index of profile of interest;
  #ntimes: how many different vectors of means are computed;
  ...
  #min_delta: minimum signal (minimum non-zero difference of all pairwise comparisons, in absolute value)
  
  #OUTPUT
  #a vector of mean values of (e0, eX, eY, eX+Y) simulating a profile of interest
