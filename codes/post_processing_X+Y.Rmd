...
outcomes = as.data.frame.matrix(table(my_results_2.5h$case,
                               my_results_2.5h$type))
...
pathway_names[grep("ubiquitination", pathway_names)]

k = grep("ubiquitination", pathway_names)[3]
...
df = rbind(df_background, df_background, df_neg,
           df_pos)
...
visualize_all_profiles(my_data_filtered_matched = my_results_2.5h)
